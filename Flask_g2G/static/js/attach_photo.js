	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","/static/photo_viewer/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
	    	 ...
	    	 welBtnConfirm.attr("src","./static/photo_viewer/btn_confirm.png");
    	 }
     }
    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
	        ...
	        aFileList.push('	<a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button" src="/static/photo_viewer/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');
    ...
    function html5Upload() {
    	...
    	sUploadURL= '/editor_photo/post'; 	//upload URL
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
			tete = new FileReader();
			tete.readAsDataURL(tempFile);
			tete.onload = function(){
				var result = "<img src='" + tete.result + "'>";

				var contents = opener.document.getElementById("htmledit");
				opener.document.getElementById("htmlbutton").click();
				contents.value = contents.value + result;
				opener.document.getElementById("editorbutton").click();
				window.close();
